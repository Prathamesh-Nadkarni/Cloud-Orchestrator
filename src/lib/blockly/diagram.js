 ...
 */
function getProviderColor(resourceType) {
 ...
 */
export function generateDiagram(hclString) {
  try {
 ...
 */
function cleanHCLForValidation(hclString) {
 ...
 */
export function validateTerraform(hclString) {
  try {
 ...
 */
function validateStructure(cleaned, parseError) {
