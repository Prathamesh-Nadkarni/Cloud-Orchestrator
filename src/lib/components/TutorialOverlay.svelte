                ...
                <div class="guide-content">
                    <div class="step">
                        ...
                        <div class="step-body">
                            ...
                            <p>
                                Use the <strong>left sidebar</strong> to browse resources
                                by cloud provider (AWS, Azure, GCP, Kubernetes, External).
                                Drag any item onto the canvas to place it.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="step">
                        ...
                        <div class="step-body">
                            ...
                            <p>
                                ...
                                > (VPCs, VNets, Subnets, K8s Clusters) to nest them.
                                The system enforces provider-matching rules automatically.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="step">
                        ...
                        <div class="step-body">
                            ...
                            <p>
                                ...
                                >
                                to another node's handle to create a network connection.
                                Click any edge to configure
                    ...
                    <div class="step">
                        ...
                        <div class="step-body">
                            ...
                            <p>
                                Click the green <strong>Generate</strong> button
                                in the top nav. The system produces
                                production-ready <strong>Terraform</strong> and
                                <strong>Kubernetes manifests</strong> from your diagram,
                                including security groups and network policies.
                            </p>
                        </div>
                    </div>

                    <div class="step">
                        <div class="step-icon"><ArrowRight size={20} /></div>
                        <div class="step-body">
